 ...
 * @{
 */
#define CC13X2_MAC_STACKSIZE       (THREAD_STACKSIZE_DEFAULT)
#ifndef CC13X2_MAC_PRIO
#define CC13X2_MAC_PRIO            (GNRC_NETIF_PRIO)
#endif

static cc13x2_rf_t cc13x2_rf_dev;
static char _cc13x2_rf_stack[CC13X2_MAC_STACKSIZE];

void auto_init_cc13x2_rf(void)
{
    LOG_DEBUG("[auto_init_netif] initializing cc13x2 radio\n");

    cc13x2_rf_setup(&cc13x2_rf_dev);
